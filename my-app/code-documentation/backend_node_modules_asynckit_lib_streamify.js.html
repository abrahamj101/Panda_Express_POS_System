...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: backend/node_modules/asynckit/lib/streamify.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: backend/node_modules/asynckit/lib/streamify.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var async = require('./async.js');
