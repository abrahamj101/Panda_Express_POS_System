...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: backend/node_modules/asynckit/lib/readable_serial_ordered.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: backend/node_modules/asynckit/lib/readable_serial_ordered.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var serialOrdered = require('../serialOrdered.js');
