...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: backend/node_modules/axios/lib/platform/common/utils.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: backend/node_modules/axios/lib/platform/common/utils.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const hasBrowserEnv = typeof window !== 'undefined' &amp;&amp; typeof document !== 'undefined';
