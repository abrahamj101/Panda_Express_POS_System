...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: backend/node_modules/pg/lib/stream.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: backend/node_modules/pg/lib/stream.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const { getStream, getSecureStream } = getStreamFuncs()
